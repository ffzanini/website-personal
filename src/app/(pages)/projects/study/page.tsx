...
export default function ProjectsStudy() {
  ...
  const breadcrumb = [
    ...
    { label: translations.projects.title_study },
  ]
  ...
  return (
    <Wrapper>
      <div className="flex flex-col gap-2 p-4">
        ...
        <h1 className="font-bold">{translations.projects.title_study}</h1>
        <p className="pb-4">{translations.projects.description_study}</p>
